...
public class CarParkOperation {
    ...
    public static void carParkCreate (CarPark totalPark, String iniFile, String iniCostFile) {
        try {
            ...
            System.out.println(iniFile + " : Park of Taxi successfully created. " + String.valueOf(totalPark.getNumberOfCars()) + " cars added.");
    ...
    public static TaxiCar[] findTheCar (CarPark totalPark, String iniFile) {
        try {
            ...
            TaxiCar lowerLimit = new TaxiCar(currentCarType, currentCarClassification, currentCarModel, currentCarNumber, currentLowerCarCost, currentLowerFuelConsumption, currentLowerPeopleCapacity);
            TaxiCar upperLimit = new TaxiCar(currentCarType, currentCarClassification, currentCarModel, currentCarNumber, currentUpperCarCost, currentUpperFuelConsumption, currentUpperPeopleCapacity);
